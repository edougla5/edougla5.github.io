...
if(currentDay==29)
    ...
    day31.style.border = 'solid white'
else {
...
function removeEvent() {
    if(events[u][0] == undefined && events[u][1] == undefined && events[u][2] == undefined) {
    ...
    if(del == 1) {
        ...
        events[u][2] = ''
    if(events[u][0] == undefined || events[u][0] == '' 
        && events[u][1] == '' || events[u][1] == undefined 
        && events[u][2] == undefined || events[u][2] == '') {
